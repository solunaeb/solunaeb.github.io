...
// 느루가 "보고 싶어!" 같은 말을 전하는 기본 설정 (여자친구가 앱의 설정에서 바꿀 수 있음)
//   every: 간격(분, 30~180), from/to: 알림 받는 시간대(KST 시)
export const LOVE_DEFAULT = { on: true, every: 60, from: 9, to: 22 };
// 웹 푸시(앱이 꺼져 있을 때)로 보내는 시각 — GitHub Actions 예약과 맞춰 둔 고정값
